...
sumNumbers farts = do 
    -- Apply the lambda function (\msg -> putStrLn msg >> getLine) to each element of the 'farts'
    -- list using 'mapM'
...
main :: IO ()
main = do
    -- Call the 'sumNumbers' function with the list of strings 
    -- ["Enter a number:", "Enter another number:", "Enter a third number:"]
